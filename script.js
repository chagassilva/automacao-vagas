...
const checkbox = document.getElementById("privacide");
const button = document.getElementById("send");

checkbox.addEventListener("change", () => {
  // Se o checkbox estiver marcado, habilita o botão
...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    try {
      const response = await fetch("https://n8n.chagassilva.com/webhook/form", {
        method: "POST",
